///
/// HybridNitroAmapManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitroamap.views
...
import com.nitroamap.*

/**
 * Represents the React Native `ViewManager` for the "NitroAmap" Nitro HybridView.
 */
public class HybridNitroAmapManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroAmap::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroAmap(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroAmapStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridNitroAmap? {
    return view.getTag(associated_hybrid_view_tag) as? HybridNitroAmap
  }
}
